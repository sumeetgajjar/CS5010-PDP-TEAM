...
public class FreecellModelTest {
  ...
  public void testInitializationOfGame() {
    ...
    for (int cascadingPiles : Arrays.asList(4, 8, 10, 20, 100, 1000)) {
      ...
      for (int openPiles : Arrays.asList(1, 4, 10, 20, 100, 1000)) {
        ...
        Assert.assertEquals(FreecellModel.convertPilesIntoString(Utils.getListOfEmptyLists(4), Utils.getListOfEmptyLists(openPiles), expectedCascadingPiles), model.getGameState());
  ...
  public void startGameAfterMove() {
    for (int cascadingPiles : Arrays.asList(4, 8, 10, 20, 100, 1000)) {
      ...
      for (int openPiles : Arrays.asList(1, 4, 10, 20, 100, 1000)) {
        ...
        Assert.assertEquals(FreecellModel.convertPilesIntoString(expectedFoundationPiles, expectedOpenPiles, expectedCascadingPiles1), model.getGameState());
        Assert.assertFalse(model.isGameOver());

        model.startGame(deck, false);
        List<List<Card>> expectedCascadingPiles2 = getCardsInCascadingPiles(cascadingPiles, deck);
        Assert.assertEquals(FreecellModel.convertPilesIntoString(Utils.getListOfEmptyLists(4), Utils.getListOfEmptyLists(openPiles), expectedCascadingPiles2), model.getGameState());
        Assert.assertFalse(model.isGameOver());
      }
    }
  }
  ...
  public void startGameWithShuffleFalse() {
    ...
    for (int cascadingPiles : Arrays.asList(4, 8, 10, 20, 100, 1000)) {
      ...
      for (int openPiles : Arrays.asList(1, 4, 10, 20, 100, 1000)) {
        ...
        List<List<Card>> expectedCascadingPiles = getCardsInCascadingPiles(cascadingPiles, validDeck);
        Assert.assertEquals(FreecellModel.convertPilesIntoString(Utils.getListOfEmptyLists(4), Utils.getListOfEmptyLists(openPiles), expectedCascadingPiles), freeCellOperations.getGameState());
      }
    }
  }
  ...
  public void moveToSamePositionAsSourcePosition() {
    for (int cascadingPiles : Arrays.asList(4, 8, 10, 20, 100, 1000)) {
      for (int openPiles : Arrays.asList(1, 4, 10, 20, 100, 1000)) {
        ...
        lastCardIndexOfAce--;
        cardFromCascadingPile = expectedCascadingCardPiles.get(lastPileOfAce).remove(lastCardIndexOfAce);
        ...
        Assert.assertEquals(FreecellModel.convertPilesIntoString(expectedFoundationPiles, expectedOpenPiles, expectedFoundationPiles), model.getGameState());
  ...
  public void sequenceOfMethodInvocationForBuilderDoesNotMatter() {
    for (int cascadingPiles : Arrays.asList(4, 8, 10, 20, 100, 1000)) {
      for (int openPiles : Arrays.asList(1, 4, 10, 20, 100, 1000)) {
        ...
        String expectedGameState1 = FreecellModel.convertPilesIntoString(Utils.getListOfEmptyLists(4), Utils.getListOfEmptyLists(openPiles), expectedCascadingPile1);
        ...
        String expectedGameState2 = FreecellModel.convertPilesIntoString(Utils.getListOfEmptyLists(4), Utils.getListOfEmptyLists(openPiles), expectedCascadingPile2);
  ...
  public void moveCardFromFoundationToCascadeWorks() {
    ...
    for (int sourcePileIndex = 0; sourcePileIndex < cascadePileCount; sourcePileIndex++) {
      ...
      Assert.assertEquals(FreecellModel.convertPilesIntoString(expectedFoundationPiles, expectedOpenPiles, expectedCascadingPiles), model.getGameState());
    }
  ...
  public void moveCardFromFoundationToFoundationWorks() {
    for (int cascadingPiles : Arrays.asList(4, 8, 10, 20, 100, 1000)) {
      for (int openPiles : Arrays.asList(1, 4, 10, 20, 100, 1000)) {
        ...
        model.move(PileType.CASCADE, lastPileOfAce, lastCardIndexOfAce, PileType.FOUNDATION, 0);
        Assert.assertEquals(FreecellModel.convertPilesIntoString(expectedFoundationPiles, Utils.getListOfEmptyLists(openPiles),
  ...
  public void moveCascadeToEmptyCascadeWorks() {
    ...
    model.move(PileType.CASCADE, 0, 0, PileType.CASCADE, cascadePileCount - 1);
    Assert.assertEquals(FreecellModel.convertPilesIntoString(expectedFoundationPiles, expectedOpenPiles, expectedCascadingPiles), model.getGameState());
    Assert.assertFalse(model.isGameOver());
  ...
  public void moveCardFromOpenPileToEmptyCascadePileWorks() {
    ...
    model.move(PileType.OPEN, 0, 0, PileType.CASCADE, cascadePileCount - 1);
    Assert.assertEquals(FreecellModel.convertPilesIntoString(expectedFoundationPiles, expectedOpenPiles, expectedCascadingPiles), model.getGameState());
    ...
    for (int cascadingPiles : Arrays.asList(4, 8, 10, 20, 100, 1000)) {
      for (int openPiles : Arrays.asList(1, 4, 10, 20, 100, 1000)) {
        ...
        for (boolean shuffle : Arrays.asList(true, false)) {
          ...
          Assert.assertEquals(FreecellModel.convertPilesIntoString(Utils.getListOfEmptyLists(4),
                  expectedOpenPiles,
  ...
  public void simulateEntireGame() {
    ...
    for (int cardIndex = 12; cardIndex >= 0; cardIndex--) {
      for (int cascadePileSouceIndex = 0, openPileDestinationIndex = 0; cascadePileSouceIndex < cascadePileCount; cascadePileSouceIndex++, openPileDestinationIndex++) {
        ...
        String expectedGameState = FreecellModel.convertPilesIntoString(expectedFoundationPiles, expectedOpenPiles, expectedCascadingPiles);
